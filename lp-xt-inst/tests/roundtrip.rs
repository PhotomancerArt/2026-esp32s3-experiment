...
fn rrr_alu() {
    ...
    let ops = [
        ...
        Quou, Quos, Remu, Rems, Min, Max, Minu, Maxu, Mul16u, Mul16s, Moveqz, Movnez, Movltz, Movgez,
    ];
    for op in ops {
        for &a in &REGS {
            for &b in &REGS {
...
#[test]
fn two_and_one_reg() {
    for op in [AluRt::Neg, AluRt::Abs, AluRt::Sra, AluRt::Srl, AluRt::Nsa, AluRt::Nsau] {
        for &a in &REGS {
            for &b in &REGS {
    ...
    for op in [ShiftSetOp::Ssr, ShiftSetOp::Ssl, ShiftSetOp::Ssa8l, ShiftSetOp::Ssa8b] {
        for &a in &REGS {
...
fn branches() {
    ...
    for &off in &offs {
        for op in [
            BrRr::Beq, BrRr::Bne, BrRr::Blt, BrRr::Bge, BrRr::Bltu, BrRr::Bgeu, BrRr::Ball,
            BrRr::Bany, BrRr::Bnall, BrRr::Bnone, BrRr::Bbc, BrRr::Bbs,
        ] {
...
fn narrow_reg_and_nullary() {
    ...
    for op in [
        NullaryNarrowOp::RetN, NullaryNarrowOp::RetwN, NullaryNarrowOp::NopN, NullaryNarrowOp::IllN,
    ] {

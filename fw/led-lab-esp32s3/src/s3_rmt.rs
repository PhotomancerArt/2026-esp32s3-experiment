...
//! through the APB FIFO port and checks that it lands at this address.
//!
...
/// interrupt-rate table in the core's README).
...
#[cfg_attr(feature = "test_loopback", allow(dead_code))]
